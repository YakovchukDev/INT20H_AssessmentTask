...
namespace QuestPlatform.Server.Data
{
    ...
    {
        public QuestPlatformDbContext(DbContextOptions<QuestPlatformDbContext> option) : base(option) { }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>()
                ...
                u => Enum.Parse<Role>(u));
            modelBuilder.Entity<PageElement>()
                .Property(pe => pe.Alignment)
                .HasConversion(
                pe => pe.ToString(),
                pe => Enum.Parse<Alignment>(pe));
        }
    }
}
